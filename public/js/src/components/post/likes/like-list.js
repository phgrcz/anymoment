...
export default class LikeList extends React.Component {
  ...
  remLikeAsAdmin = e => {
    ...
    decrementLikes()
    Notify({ value: 'Apagado como admin' })
  }
      ...
      <div className='modal_items fer_items' >
        ...
        <div className='modal_it_content'>
          ...
          <div className='modal_ff'>
            {
              isAdmin() ?
                <a href='#' className='sec_btn' onClick={this.remLikeAsAdmin} >Remove como admin</a>

                : Me(like_by) ?
                  <Link to={`/profile/${username}`} className='pri_btn follow' >Perfil</Link>
