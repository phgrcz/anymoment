      ...
      <div>
        ...
        <FadeIn duration='300ms'>
          ...
          <div className='exp_nav'>
            <ul>
              <li>
                <NavLink to={`${url}`} exact activeClassName='exp_nav_active' className='exp_nav_link'>Usuários</NavLink>
              </li>
              <li>
                <NavLink to={`${url}/explore-photos`} activeClassName='exp_nav_active' className='exp_nav_link'>Momentos</NavLink>
              </li>
              <li>
                <NavLink to={`${url}/explore-groups`} activeClassName='exp_nav_active' className='exp_nav_link'>Grupos</NavLink>
              </li>
            </ul>

            <a className='exp_refresh' data-tip='Atualizar' href='#' onClick={this.refresh} >
