...
export default class Post extends React.Component {
  ...
  remBookmarkAsAdmin = async e => {
    ...
    dispatch(unbookmark(post_id))
    Notify({ value: 'Momento removido como admin' })
  }
    ...
    return (
      <div className='posts' >
...

        {
          when == 'shared' ?
            <div className='post_share_info'>
              por <Link to={`/profile/${share_by_username}`} >{share_by_username}</Link>
        ...
        <div className='p_i'>
          ...
          >
            <ul>
              { when != 'viewPost' ? <li><Link to={`/post/${post_id}`} >Abrir</Link></li> : null }

              {
                fn.Me(user) || fn.isAdmin() ?
                  <li>
                    ...
                    >Editar momento {fn.isAdmin() ? 'como admin' : null}</a>
                  </li>
                  : null
              }

              {
                fn.Me(user) || fn.isAdmin() ?
                  <li>
                    ...
                    >Apagar momento {fn.isAdmin() ? 'como admin' : null}</a>
                  </li>
                  : null
              }

              {
                when == 'bookmarks' && fn.isAdmin() ?
                  <li>
                    <a href='#' onClick={this.remBookmarkAsAdmin} >Remover dos salvos como admin</a>
                  </li>
                  : null
              }
              ...
              tags_count != 0 ?
                <div>
                  <span
                    ...
                    data-tip={`${fn.humanReadable(tags_count, 'marcados')}`}
        ...
        <div className='p_a'>
          <div className='p_do'>
            ...
            <div className='p_send_wra'>
              ...
              ><i className='material-icons'>share</i></span>
            </div>
          </div>
          ...
          <div className='p_did'>
            ...
            >{fn.humanReadable(likes_count, 'curtidas')}</span>
            <span
              className='p_comm'
              onClick={() => this._toggle('showSharers')}
            >{fn.humanReadable(shares_count, 'compartilhamentos')}</span>
          </div>
        </div>
        ...
        <Link
          to={`/post/${post_id}`}
          className='p_comments' >{ fn.humanReadable(comments_count, 'comentários') }
        </Link>
        ...
        <div className='p_cit'>
          ...
          <div className='p_cit_main'>
            ...
            <div className='p_cit_tool'>
              <span className='c_sticker' data-tip='Adesivo' onClick={() => this._toggle('showStickers')} >
              ...
              <form className='p_comment_form' encType='multipart/form-data'>
                ...
                />
                <label for='p_comm_file' className='p_cit_more' data-tip='Imagem'>
          ...
          deletePost ?
            <Fragment>
              ...
              <Prompt
                ...
                content="Este momento será apagado"
                actionText= 'Apagar'
