          ...
          <div className='edit_profile'>
            ...
            <div className='edit_main'>
              <div className='edit_un_div'>
                <span className='edit_span'>@usuario</span>
                <input
                  type='text'
                  name='edit_un_text'
              ...
              <div className='edit_fn_div edit_small'>
                <span className='edit_span'>Nome</span>
                <input
                  type='text'
                  name='edit_fn_text'
              ...
              <div className='edit_sn_div edit_small'>
                <span className='edit_span'>Sobrenome</span>
                <input
                  type='text'
                  name='edit_sn_text'
              ...
              <div className='edit_email_div'>
                <span className='edit_span'>E-mail</span>
                <input
                  type='email'
              ...
              <div className='edit_bio_div'>
                <span className='edit_span'>Sobre</span>
                <textarea
                  name='edit_ta'
                  className='edit_ta'
                  placeholder='sobre'
              ...
              <div className='edit_update'>
                ...
                <a href='#' className='pri_btn edit_done' onClick={this.editProfile} >Editar</a>
                {
                  !e_v()
                    ? <a
                      href='#'
                    ...
                    >Reenviar e-mail de verificação</a>
                    : null
                }
              </div>
            </div>
