...
export default class Avatars extends React.Component {
  ...
  state = {
    ...
    previewAvatar: '/images/default_avatar.png', // preview Image for previewAvatar component
      ...
      <div className='pro_avatars'>
        ...
        <div className='pro_ava_bottom'>
          <form className='pro_ch_form' method='post' encType='multipart/formdata'>
            ...
            />
            <label for='pro_ch_ava' className='sec_btn'>Upload</label>
          </form>
          <div className='pro_ava_bottom_act'>
            <a href='#' className='sec_btn' onClick={this.back} >Cancelar</a>
            <a
              href='#'
              className={`pri_btn btn_select_avatar ${loading ? 'a_disabled' : ''}`}
              onClick={this.changeAvatar} >Alterar</a>
          </div>
        </div>
