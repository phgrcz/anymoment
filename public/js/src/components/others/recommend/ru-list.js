...
export default class RecommendUsersList extends React.Component {
  ...
  recommend = async e => {
    ...
    if (success) {
      ...
      Notify({ value: `${getUsername} recomendado para ${username}` })
    } else {
      Notify({ value: 'Não pode ser recomendado' })
    }
      ...
      <div className='modal_items'>
        ...
        <div className='modal_it_content '>
          ...
          <div className='modal_ff'>
            <a href='#' className='share_btn pri_btn' onClick={this.recommend} >Recomendar</a>
          </div>
        </div>
        <hr/>
      </div>
