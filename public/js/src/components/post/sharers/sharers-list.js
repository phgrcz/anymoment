        ...
        <div className='modal_it_content'>
          <div className='modal_it_info'>
            <Link to={`/profile/${share_by_username}`} className='modal_it_username' >
              { Me(share_by) ? 'você' : share_by_username }
            </Link>
            <span className='modal_it_light' >com { Me(share_to) ? 'você' : share_to_username }</span>
          </div>
          <div className='modal_ff'>
            {
              Me(share_by) ?
                <Link to={`/profile/${share_by_username}`} className='pri_btn follow' >Perfil</Link>
