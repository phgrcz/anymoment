          ...
          <FadeIn duration='300ms'>
            ...
            <div className='i_p_main p_main' style={{ height: 296 }} >
              {
                ...
                fileChanged ?
                  ...
                  <form className='post_img_form' method='post' encType='multipart/formdata'>
                    ...
                    />
                    <label for='post_img' className='pri_btn'>Escolha uma imagem</label>
                  </form>
              }
            ...
            <div className='t_p_bottom p_bottom'>
              ...
              <div className='t_p_act p_act'>
                <a href='#' className='sec_btn p_cancel' onClick={back} >Cancelar</a>
                <a href='#' className={`pri_btn p_post ${!fileChanged ? 'a_disabled' : ''}`} onClick={this.addPost} >Publicar</a>
              </div>
            </div>
          </FadeIn>
        </div>
